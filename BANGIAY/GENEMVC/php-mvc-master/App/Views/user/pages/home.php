<div class="ps-banner">
        <div class="rev_slider fullscreenbanner" id="home-banner">
          <ul>
            <li class="ps-banner" data-index="rs-2972" data-transition="random" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off" data-rotate="0"><img class="rev-slidebg" src="images/slider/7.jpg" alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="5" data-no-retina>
            ...
            <li class="ps-banner ps-banner--white" data-index="rs-100" data-transition="random" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off" data-rotate="0"><img class="rev-slidebg" src="/GENEMVC/php-mvc-master/public/images/slider/6.jpg" alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="5" data-no-retina>
  ...
  <?php  
     foreach($product as $value){
       $id = $value['id_pro'];
       ?>
  <div class="grid-item nike col-md-4">
                  <div class="grid-item__content-wrapper">
                    <div class="ps-shoe mb-30">
                      <div class="ps-shoe__thumbnail"><a class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img src="./images/shoe/<?php echo $value['productImage'] ?>" alt=""><a class="ps-shoe__overlay" href="/BANGIAY/GENEMVC/php-mvc-master/public/productdetail/<?php echo $value['id_pro']?>"></a>
                      </div>
                      <div class="ps-shoe__content">
                        <div class="ps-shoe__variants">
                          <div class="ps-shoe__variant normal">
                          <?php 
   foreach($prode as $value1){
    if($value1['id_pro']==$id){ 
    ?>
         <a href="./productImg/<?php echo $value1['id_prode']?>"> <img src="images/shoe/<?php echo $value1['image'];?>" alt=""> </a>
   <?php }
   }
   ?> 
                          </div>
                        ...
                        <div class="ps-shoe__detail"><a class="ps-shoe__name" href="#"><?php echo $value['productname']?></a>
                          <p class="ps-shoe__categories"><a href="#">Men shoes</a>,<a href="#"> Nike</a>,<a href="#"> Jordan</a></p><span class="ps-shoe__price"> <?php echo number_format($product[0]['price'], 0, ',', '.')?> VNĐ </span>
                        </div>
                      </div>
                    </div>
                  </div>
  ...
  ?>
      ...
      <div class="ps-section--offer">
        <div class="ps-column"><a class="ps-offer" href="product-listing.html"><img src="images/banner/pp1.jpg" alt=""></a></div>
        <div class="ps-column"><a class="ps-offer" href="product-listing.html"><img src="images/banner/pp2.jpg" alt=""></a></div>
      </div>
      ...
      <div class="ps-home-testimonial bg--parallax pb-80" data-background="images/background/pp2.jpg">
        <div class="container">
          ...
          <div class="ps-section__content">
            <div class="row">
                  <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 ">
                    <div class="ps-post">
                      <div class="ps-post__thumbnail"><a class="ps-post__overlay" href=""></a><img src="images/blog/blog1.jpg" alt=""></div>
                  ...
                  <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 ">
                    <div class="ps-post">
                      <div class="ps-post__thumbnail"><a class="ps-post__overlay" href=""></a><img src="images/blog/blog2.png" alt=""></div>
                  ...
                  <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 ">
                    <div class="ps-post">
                      <div class="ps-post__thumbnail"><a class="ps-post__overlay" href=""></a><img src="images/blog/blog3.jpg" alt=""></div>
