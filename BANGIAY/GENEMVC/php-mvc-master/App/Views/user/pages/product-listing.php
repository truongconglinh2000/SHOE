             ...
             <div class="ps-product__column">
              <div class="ps-shoe mb-30">
                <div class="ps-shoe__thumbnail">
                  ...
                  <div class="ps-badge ps-badge--sale ps-badge--2nd"><span>-35%</span></div><a class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img src="images/shoe/<?php echo $value['productImage'];?>" alt=""><a class="ps-shoe__overlay" href="/BANGIAY/GENEMVC/php-mvc-master/public/productdetail/<?php echo $value['id_pro']?>"></a>
                </div>
                <div class="ps-shoe__content">
                  ...
                  <div class="ps-shoe__detail"><a class="ps-shoe__name" href="#"><?php echo $value['productname'] ?></a>
                    <p class="ps-shoe__categories"><a href="#">Men shoes</a>,<a href="#"> Nike</a>,<a href="#"> Jordan</a></p><span class="ps-shoe__price">
                      <del>£220</del> <?php echo $value['price'];?></span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <aside class="ps-widget--sidebar ps-widget--category">
            ...
            <div class="ps-widget__content">
              <ul class="ps-list--checked">
                <li class="current"><a href="./subCat/<?php echo $cate[0]['id_subcat'];?>"><?php echo $cate[0]['title_subcat']?></a></li>
                <?php foreach($cate as $value){
                  if($value['title_subcat']!=$cate[0]['title_subcat']){
                  ?>
                  <li><a href=""><?php echo $value['title_subcat']?></a></li>
                  <?php }} ?>
